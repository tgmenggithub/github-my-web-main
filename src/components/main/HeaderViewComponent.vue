<template>
    <!--    头部-->
    <div>
<!--        <nav class="navigation container header-style" data-v-83148ee2="">-->
...
<!--                        <div class="items" data-v-4f6a3544="">&lt;!&ndash;&ndash;&gt;-->
<!--                            <div tabindex="0" class="dropdown" data-v-538d6fa0="" data-v-4f6a3544="">-->
<!--                                <button class="title" data-v-538d6fa0="">-->
<!--                                    Student-->
<!--                                    <svg width="10" height="6" viewbox="0 0 10 6" fill="none"-->
<!--                                         xmlns="http://www.w3.org/2000/svg" data-v-538d6fa0="">-->
...
<!--                                    </svg>-->
<!--                                </button> &lt;!&ndash;&ndash;&gt;</div>&lt;!&ndash;&ndash;&gt;-->
<!--                            <div tabindex="0" class="dropdown" data-v-538d6fa0="" data-v-4f6a3544="">-->
<!--                                <button class="title" data-v-538d6fa0="">-->
<!--                                    Teacher-->
<!--                                    <svg width="10" height="6" viewbox="0 0 10 6" fill="none"-->
...
<!--                                              fill="currentColor"></path>-->
<!--                                    </svg>-->
<!--                                </button> &lt;!&ndash;&ndash;&gt;</div>-->
<!--                            <a href="/schools" data-v-4f6a3544="">Schools</a> &lt;!&ndash;&ndash;&gt;<a href="/benefits"-->
<!--                                                                                        data-v-4f6a3544="">Benefits</a>-->
<!--                            &lt;!&ndash;&ndash;&gt;<a href="/events" data-v-4f6a3544="">Events</a> &lt;!&ndash;&ndash;&gt;</div>-->
<!--                        <div class="actions" data-v-4f6a3544=""><a href="/sign_in" class="menu-button"-->
<!--                                                                   data-v-4f6a3544="">Sign in</a></div>-->
<!--                    </div>-->
<!--                </div>-->
<!--                <button class="button" data-v-4b086efc="" data-v-4f6a3544="">-->
...
<!--                              class="line line1" data-v-4b086efc=""></path>-->
...
<!--                              class="line line3" data-v-4b086efc=""></path>-->
<!--                    </svg>-->
<!--                </button>-->
<!--            </div>-->
<!--        </nav>-->
